...
const TableKamar = ({ role, id_admin_login }) => {
    ...
    const getData = async (searchTerm = '') => {
        ...
        try {
            ...
            if (role === "admin" || role === "dinas") {
                url = `${process.env.REACT_APP_BACKEND_API_URL}/api/kamar/get_data/byAdmin?keyword=${searchTerm}`;
            }
            else if (role === "admin industri") {
                url = `${process.env.REACT_APP_BACKEND_API_URL}/api/kamar/get_data/byAdmin?byAdmin=${id_admin_login}&keyword=${searchTerm}`;
            }
            else if (role === "user industri") {
                url = `${process.env.REACT_APP_BACKEND_API_URL}/api/kamar/get_data/byAdmin?byAdminPengelola=${id_admin_login}&keyword=${searchTerm}`;
            }
            else {
                url = `${process.env.REACT_APP_BACKEND_API_URL}/api/kamar/get_data/byAdmin?keyword=${searchTerm}`;
            }
    ...
    useEffect(() => {
        ...
        const currentPageData = DataKamar.slice(offset, offset + itemsPerPage);
        const pageCount = Math.ceil(DataKamar.length / itemsPerPage);
        ...
        const openModalEdit = (
            ...
            setFormDataEdit({
                ...
                sampul_kamar: sampul,
                ruang_kamar: ruang,
                ruang_kamar_dua: ruang2,
                ruang_kamar_tiga: ruang3,
                ruang_kamar_empat: ruang4,
                ruang_kamar_lima: ruang5,
            });
...
// UNTUK MEMPERBAIKI VERIFIKASI
        const openModalFormVerifikasi = (id_kamar, status, id_admin) => {
            if (role === "admin" || role === "dinas") {
        ...
        const handleSubmit = async (e) => { //PERHATIKAN
            ...
            if (croppedImage && croppedImage2 && croppedImage3 && croppedImage4 && croppedImage5 && croppedImage6) {
                ...
                try {
                    const response = await axios.post(`${process.env.REACT_APP_BACKEND_API_URL}/api/kamar/add_data/byAdmin`, formDataObj)
                    if (response) {
        ...
        formDataObj.append("nama_kamar", formDataEdit.nama_kamar);
        formDataObj.append("deskripsi", formDataEdit.deskripsi);
        formDataObj.append("harga", formDataEdit.harga);
        formDataObj.append("kapasitas", formDataEdit.kapasitas);
        formDataObj.append("jumlah_kamar", formDataEdit.jumlah_kamar);
        formDataObj.append("bebas_rokok", formDataEdit.bebas_rokok);
        formDataObj.append("fasilitas_sarapan", formDataEdit.fasilitas_sarapan);
        ...
        try {
            const response = await axios.put(`${process.env.REACT_APP_BACKEND_API_URL}/api/kamar/update/byAdmin/${formDataEdit.id_kamar}`, formDataObj)
            if (response) {
                setResponseMessage(response.data.message);
                setResponseMessageStatus(response.data.status);
                closeModalEdit();
    ...
    const handleSubmitDelete = async (e) => {
        ...
        try {
            const response = await axios.delete(`${process.env.REACT_APP_BACKEND_API_URL}/api/kamar/delete/byAdmin/${DataDelete.id}`)
            if (response) {
                setResponseMessage(response.data.message);
                setResponseMessageStatus(response.data.status);
                closeModalDelete();
    ...
    const handleSubmitUpdateVerifikasi = async (e) => {
        ...
        try {
            const response = await axios.put(`${process.env.REACT_APP_BACKEND_API_URL}/api/kamar/verif/byAdmin/${DataFormVerifikasi.id_kamar}`, {
                            ...
                            <div className="modal-content slideDown">
                                ...
                                <div className="modal-body">
                                    <form onSubmit={handleSubmit} className="modal-form">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="status_penginapan">Bebas Rokok</label>
                                            <select
                                                className="form-control"
                                                name="bebas_rokok"
                                                style={{ width: '100%' }}
                                                value={formData.bebas_rokok}
                                                onChange={handleInputChange}
                                                required
                                            >
                                                <option value="">--- Pilih Aturan ---</option>
                                                <option value="true">Bebas Merokok</option>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <select
                                                ...
                                                style={{ width: '100%' }}
                                                value={formData.fasilitas_sarapan}
                                                onChange={handleInputChange}
                                                required
                                            >
                                                <option value="">--- Pilih Aturan ---</option>
                                ...
                                <div className="modal-body">
                                    <form className="modal-form" onSubmit={handleSubmitUpdate}>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div>
                                                <img src={`${formDataEdit.sampul_kamar}`} alt={formDataEdit.sampul_kamar} style={{ width: '150px' }} />
                                            </div>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div>
                                                {formDataEdit.ruang_kamar ? (
                                                    <img src={`${formDataEdit.ruang_kamar}`} alt={formDataEdit.ruang_kamar} style={{ width: '150px' }} />
                                                ) : (
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div>
                                                {formDataEdit.ruang_kamar_dua ? (
                                                    <img src={`${formDataEdit.ruang_kamar_dua}`} alt={formDataEdit.ruang_kamar_dua} style={{ width: '150px' }} />
                                                ) : (
                                                    <span className='text-danger'>Belum diunggah</span>
                                                )}
                                            </div>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div>
                                                {formDataEdit.ruang_kamar_tiga ? (
                                                    <img src={`${formDataEdit.ruang_kamar_tiga}`} alt={formDataEdit.ruang_kamar_tiga} style={{ width: '150px' }} />
                                                ) : (
                                                    <span className='text-danger'>Belum diunggah</span>
                                                )}
                                            </div>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div>
                                                {formDataEdit.ruang_kamar_empat ? (
                                                    <img src={`${formDataEdit.ruang_kamar_empat}`} alt={formDataEdit.ruang_kamar_empat} style={{ width: '150px' }} />
                                                ) : (
                                                    <span className='text-danger'>Belum diunggah</span>
                                                )}
                                            </div>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div>
                                                {formDataEdit.ruang_kamar_lima ? (
                                                    <img src={`${formDataEdit.ruang_kamar_lima}`} alt={formDataEdit.ruang_kamar_lima} style={{ width: '150px' }} />
                                                ) : (
                                                    <span className='text-danger'>Belum diunggah</span>
                                                )}
                                            </div>
                ...
                <div className="col-lg-12 grid-margin stretch-card mt-3">
                        <div className="card">
                            <div className="card-body">
                                <h4 className="card-title">Tabel Data Kamar Hotel</h4>
                                {responseMessage && (
                                                ...
                                                <>
                                                    {currentPageData.map((item, index) => (
                                                        <tr key={index}>
                                                            ...
                                                            <td className={item.kapasitas ? "text-dark" : "text-danger"}>{item.kapasitas ? item.kapasitas : "Undifined"}</td>
                                                            ...
                                                            {item.detail_admin_verified ? (
                                                                <td><label className={`badge ${item.status_verifikasi === "verified" ? " badge-success" : " badge-danger"}`}
                                                                    ...
                                                                    :   () => openModalFormVerifikasi(item.id_kamar, item.status_verifikasi, item.detail_admin_verified.id_admin)}
                                                                >
                                                                ...
                                                                <td><label className={`badge badge-warning`}
                                                                    onClick={() => openModalFormVerifikasi(item.id_kamar, item.status_verifikasi, item.detail_admin_verified)}
                                                                >Belum diverifikasi</label></td>
                                                            )}
                                                            <td><Link to={`/kamar/${item.id_kamar}`}>Lihat detail</Link>
                                                                <FontAwesomeIcon className='mx-2' icon={faEdit} onClick={() => openModalEdit(
                                                                    ...
                                                                    item.nama_kamar ? item.nama_kamar : '',
                                                                    item.deskripsi ? item.deskripsi : '',
                                                                    item.harga ? item.harga : '',
                                                                    item.kapasitas ? item.kapasitas : '',
                                                                    item.jumlah_kamar ? item.jumlah_kamar : '',
                                                                    item.bebas_rokok ? item.bebas_rokok : '',
                                                                    item.fasilitas_sarapan ? item.fasilitas_sarapan : '',
                                                                    item.sampul_kamar,
                                                                    item.ruang_kamar,
                                                                ...
                                                                <FontAwesomeIcon icon={faTrash} onClick={() => openModalDelete(item.id_kamar, item.nama_kamar, item.sampul_kamar)} />
                                                            </td>
                                                        </tr>
                                                    ))}
                                                </>
