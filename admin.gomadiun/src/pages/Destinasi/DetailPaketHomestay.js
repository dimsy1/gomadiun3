...
const DetailPaketHomestay = ({ role, id_admin_login }) => {
    const { id_paket_homestay } = useParams();
    const navigate = useNavigate();
    const [DataUsers, setDataUsers] = useState([]);
    const [DataDetailPakethomestay, setDataDetailPakethomestay] = useState([]);
    ...
    const getData = async () => {
        ...
        setDataDetailPakethomestay(null);
        ...
        try {
            ...
            const url = `${process.env.REACT_APP_BACKEND_API_URL}/api/homestay/detail/byAdmin/${id_paket_homestay}`;
            const response = await axios.get(url);
            ...
            if (response.data && response.data.data) {
                ...
                // Set data untuk `DataDetailPakethomestay`
                setDataDetailPakethomestay(data);
    
                // Periksa dan set list fasilitas jika ada
                if (data[0]?.detail_fasilitas_homestay?.length > 0) {
                    setListFasilitas(
                        data[0].detail_fasilitas_homestay.map((item) => item.value_fasilitas_paket)
                    );
                }
    ...
    const openModalChangesFasilitas = (id_paket_homestay, status) => {
        if (status === "update") {
    ...
    const openModalFormVerifikasi = (id_paket_homestay, status) => {
        if (role === "dinas") {
            ...
            <div className="content-wrapper">
                <div className="row">
                    <div className='d-flex w-100'>
                        <h4 className="card-title">Detail Kamar</h4>
                    </div>
                            ...
                            <div className="modal-body">
                                <form className="modal-form" onSubmit={handleSubmitUpdateFasilitas}>
                                    ...
                                    <div className="pl-2 py-3 d-flex flex-row">
                                        ...
                                        />
                                        <span className='ml-2'>Kamar Mandi Bersama</span>
                                    </div>
                                    ...
                                    <div className="pl-2 d-flex flex-row">
                                        ...
                                        />
                                        <span className='ml-2'>Perlengkapan Mandi</span>
                                    </div>
                            ...
                            <div className="card-body">
                                ...
                                {!loadingMuatHalDetail ? (
                                    ...
                                    <div className='d-flex flex-column my-5'>
                                        {DataDetailPakethomestay[0] ? (
                                            <div>
                                                {DataDetailPakethomestay.map((item, index) => (
                                                    <div className='cover-detail-content' style={{ display: activeTab === "Detail Kamar" ? "" : "none" }}>
                                                        <div className='detail-content'>
                                                            <div className='detail-content-row'>
                                                                <span className='title-name'>Nama Kamar</span>
                                                                <span>:</span>
                                                                <span className='subtitle-name'>{item.nama_paket_homestay}</span>
                                                            </div>
                                                            <div className='detail-content-row'>
                                                                <span className='title-name'>Nama Penginapan</span>
                                                                <span>:</span>
                                                                {item.detail_penginapan ? (
                                                                    <span className='subtitle-name'>{item.detail_penginapan.nama_penginapan}</span>
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
                                                            <div className='detail-content-row'>
                                                                <span className='title-name'>Admin Kamar</span>
                                                                <span>:</span>
                                                                <span className='subtitle-name'>{item.detail_admin.nama_admin}</span>
                                                            </div>
                                                            <div className='detail-content-row'>
                                                                <span className='title-name'>User Kamar</span>
                                                                <span>:</span>
                                                            ...
                                                            <div className='detail-content-row'>
                                                                <span className='title-name'>Deskripsi Kamar</span>
                                                                <span>:</span>
                                                                <span className='subtitle-name' style={{ whiteSpace: 'pre-wrap', width: 850 }}>{item.deskripsi_paket_homestay}</span>
                                                            </div>
                                                        ...
                                                        <div className='detail-content-row'>
                                                                ...
                                                                <div className='subtitle-name'>
                                                                    {item.detail_fasilitas_homestay.length !== 0 ? (
                                                                        <>
                                                                            <div className='d-flex flex-column mb-2'>
                                                                                {item.detail_fasilitas_homestay.map((item, index) => {
                                                                                    return (
                                                                                        <span key={index} className='px-1'>- {item.nama_fasilitas_paket}</span>
                                                                                    )
                                                                                })}
                                                                            </div>
                                                                            <label className={`badge badge-success mt-0`}
                                                                                onClick={() => openModalChangesFasilitas(item.id_paket_homestay, "update")}
                                                                            >
                                                                                Ubah list fasilitas
                                                                            </label>
                                                                        </>
                                                                        ...
                                                                        <label className={`badge badge-warning mt-0`}
                                                                            onClick={() => openModalChangesFasilitas(item.id_paket_homestay, "add")}
                                                                        >Tambahkan list fasilitas</label>
                                                                    )}
                                                                </div>
                                                            </div>
                                                            <div className='detail-content-row'>
                                                                <span className='title-name'>Harga Kamar</span>
                                                                <span>:</span>
                                                                {item.harga ? (
                                                                    <span className='subtitle-name'>{item.harga}</span>
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className='detail-content-row-wisata'>
                                                                <span className='title-name'>Foto Sampul Kamar</span>
                                                                <span>:</span>
                                                                <img src={item.sampul_paket_homestay} alt={item.sampul_paket_homestay} />
                                                            </div>

                                                            <div className='detail-content-row-wisata'>
                                                                <span className='title-name'>Foto Ruang kamar</span>
                                                                <span>:</span>
                                                                {item.ruang_paket_homestay ? (
                                                                    <img src={item.ruang_paket_homestay} alt={item.ruang_paket_homestay} />
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className='detail-content-row-wisata'>
                                                                ...
                                                                {item.ruang_paket_homestay_dua ? (
                                                                    <img src={item.ruang_paket_homestay_dua} alt={item.ruang_paket_homestay_dua} />
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className='detail-content-row-wisata'>
                                                                ...
                                                                {item.ruang_paket_homestay_tiga ? (
                                                                    <img src={item.ruang_paket_homestay_tiga} alt={item.ruang_paket_homestay_tiga} />
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className='detail-content-row-wisata'>
                                                                ...
                                                                {item.ruang_paket_homestay_empat ? (
                                                                    <img src={item.ruang_paket_homestay_empat} alt={item.ruang_paket_homestay_empat} />
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className='detail-content-row-wisata'>
                                                                ...
                                                                {item.ruang_paket_homestay_lima ? (
                                                                    <img src={item.ruang_paket_homestay_lima} alt={item.ruang_paket_homestay_lima} />
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
...
export default DetailPaketHomestay;
