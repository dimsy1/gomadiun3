...
const DetailMenu = ({ role, id_admin_login }) => {
    ...
    const [activeTab, setActiveTab] = useState('Detail Menu');
    ...
    const getData = async (tahun = '') => {
        ...
        try {
            ...
            const url = `${process.env.REACT_APP_BACKEND_API_URL}/api/menu/detail/byAdmin/${id_menu}`;
    
            const response = await axios.get(url);
            if (response) {
                setDataDetailMenu(response.data.data);
            ...
            <div className="content-wrapper">
                <div className="row">
                    <div className='d-flex w-100'>
                        <h4 className="card-title">Detail Menu</h4>
                    </div>
                                        ...
                                        {DataDetailMenu[0] ? (
                                            <div>
                                                {DataDetailMenu.map((item, index) => (
                                                    <div className='cover-detail-content' style={{ display: activeTab === "Detail Menu" ? "" : "none" }}>
                                                        <div className='detail-content'>
                                                            <div className='detail-content-row'>
                                                                <span className='title-name'>Nama Menu</span>
                                                                <span>:</span>
                                                                <span className='subtitle-name'>{item.nama_menu}</span>
                                                            </div>
                                                            <div className='detail-content-row'>
                                                                <span className='title-name'>Jenis Kuliner</span>
                                                                <span>:</span>
                                                                {item.detail_kategori_menu ? (
                                                                    <span className='subtitle-name'>{item.detail_kategori_menu.nama_kategori_menu}</span>
                                                                ) : (
                                                            ...
                                                            <div className='detail-content-row'>
                                                                ...
                                                                <span>:</span>
                                                                {item.detail_kuliner ? (
                                                                    <span className='subtitle-name'>{item.detail_kuliner.nama_kuliner}</span>
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className='detail-content-row'>
                                                                <span className='title-name'>Harga Menu</span>
                                                                <span>:</span>
                                                                {item.harga_menu ? (
                                                                    <span className='subtitle-name'>{item.harga_menu}</span>
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className='detail-content-row'>
                                                                <span className='title-name'>Status Menu</span>
                                                                <span>:</span>
                                                                {item.status_tersedia ? (
                                                                    <span className={`subtitle-name fw-bold ${item.status_tersedia === "tersedia" ? "text-success" : item.status_tersedia === "habis" ? "text-danger" : "text-dark"}`}
                                                                            style={{ textTransform: 'capitalize', fontWeight: 'bold' }}
                                                                        >
                                                                {item.status_tersedia}
                                                                    </span>
                                                                ) : (
                                                                    <span className='subtitle-name text-danger fw-bold' style={{ textTransform: 'capitalize' }}>
                                                                        Undifined
                                                                    </span>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className='detail-content-row-wisata'>
                                                                <span className='title-name'>Foto Sampul Menu</span>
                                                                <span>:</span>
                                                                <img src={item.sampul_menu} alt={item.sampul_menu} />
                                                            </div>
