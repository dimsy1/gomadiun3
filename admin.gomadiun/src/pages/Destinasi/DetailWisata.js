...
const TableDetailWisata = ({ role, id_admin_login }) => {
    ...
    const exportDataPengunjung = async () => {
        try {
            const response = await axios.get(`http://localhost:3001/api/pengunjung/export-data-pengunjung/wisata/${id_wisata}`, { responseType: 'json' });
            ...
            const fileName = `data_pengunjung_wisata_${destinationName.replace(/\s+/g, '_')}_${Date.now()}.xlsx`;
                                                ...
                                                {DataDetailWisata.map((item, index) => (
                                                    <div className='cover-detail-content' style={{ display: activeTab === "Detail Wisata" ? "" : "none" }}>
                                                        <div className='detail-content'>
                                                            ...
                                                            <div className='detail-content-row'>
                                                                <span className='title-name'>Kategori Destinasi</span>
                                                                <span>:</span>
                                                                {item.kategori ? (
                                                                    <span className='subtitle-name'>{item.kategori}</span>
                                                                ) : (
                                                            ...
                                                            <div className='detail-content-row-wisata'>
                                                                <span className='title-name'>Foto Sampul Destinasi Wisata</span>
                                                                <span>:</span>
                                                                <img src={item.sampul_destinasi} alt={item.sampul_destinasi} />
                                                            </div>
                                                            <div className='detail-content-row-wisata'>
                                                                <span className='title-name'>Foto Ruang Destinasi Wisata</span>
                                                                <span>:</span>
                                                ...
                                                <div className='mt-5' style={{ display: activeTab === "Data Pengunjung" ? "" : "none" }}>
                                                    ...
                                                    <div className="container-top">
                                                        ...
                                                        <button 
                                                            ...
                                                            onClick={() => exportDataPengunjung(id_wisata, 'wisata')}
