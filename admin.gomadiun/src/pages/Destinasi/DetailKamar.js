...
const DetailKamar = ({ role, id_admin_login }) => {
    const { id_kamar } = useParams();
    const navigate = useNavigate();
    const [DataUsers, setDataUsers] = useState([]);
    const [DataDetailKamar, setDataDetailKamar] = useState([]);
    ...
    const getData = async (tahun = '') => {
        ...
        try {
            ...
            const url = `${process.env.REACT_APP_BACKEND_API_URL}/api/kamar/detail/byAdmin/${id_kamar}`;
    ...
    const openModalFormVerifikasi = (id_kamar, status) => {
        if (role === "dinas") {
                            ...
                            <div className="card-body">
                                ...
                                {!loadingMuatHalDetail ? (
                                    ...
                                    <div className='d-flex flex-column my-5'>
                                        {DataDetailKamar[0] ? (
                                            <div>
                                                {DataDetailKamar.map((item, index) => (
                                                    <div className='cover-detail-content' style={{ display: activeTab === "Detail Kamar" ? "" : "none" }}>
                                                        <div className='detail-content'>
                                                            <div className='detail-content-row'>
                                                                ...
                                                                <span>:</span>
                                                                <span className='subtitle-name'>{item.nama_kamar}</span>
                                                            </div>
                                                            <div className='detail-content-row'>
                                                            ...
                                                            <div className='detail-content-row'>
                                                                ...
                                                                <span>:</span>
                                                                <span className='subtitle-name' style={{ whiteSpace: 'pre-wrap', width: 850 }}>{item.deskripsi}</span>
                                                            </div>
                                                            <div className='detail-content-row'>
                                                            ...
                                                            <div className='detail-content-row'>
                                                                <span className='title-name'>Kapasitas</span>
                                                                <span>:</span>
                                                                {item.kapasitas ? (
                                                                    <span className='subtitle-name'>{item.kapasitas}</span>
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
                                                            <div className='detail-content-row'>
                                                                <span className='title-name'>Jumlah Kamar</span>
                                                                <span>:</span>
                                                                {item.jumlah_kamar ? (
                                                                    <span className='subtitle-name'>{item.jumlah_kamar}</span>
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
                                                            <div className='detail-content-row'>
                                                            <span className='title-name'>Bebas Merokok</span>
                                                            <span>:</span>
                                                            <span className='subtitle-name'>
                                                                    {item.bebas_rokok === "true" ? "Ya" : item.bebas_rokok === "false" ? "Tidak" : "Kategori tidak diketahui"}
                                                                </span>
                                                                </div>
                                                            <div className='detail-content-row'>
                                                            <span className='title-name'>Fasilitas Sarapan</span>
                                                            <span>:</span>
                                                            <span className='subtitle-name'>
                                                                    {item.fasilitas_sarapan === "true" ? "Ya" : item.fasilitas_sarapan === "false" ? "Tidak" : "Kategori tidak diketahui"}
                                                                </span>
                                                                </div>
                                                            ...
                                                            <div className='detail-content-row-wisata'>
                                                                ...
                                                                <span>:</span>
                                                                <img src={item.sampul_kamar} alt={item.sampul_kamar} />
                                                            </div>
                                                            ...
                                                            <div className='detail-content-row-wisata'>
                                                                ...
                                                                <span>:</span>
                                                                {item.ruang_kamar ? (
                                                                    <img src={item.ruang_kamar} alt={item.ruang_kamar} />
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className='detail-content-row-wisata'>
                                                                ...
                                                                {item.ruang_kamar_dua ? (
                                                                    <img src={item.ruang_kamar_dua} alt={item.ruang_kamar_dua} />
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className='detail-content-row-wisata'>
                                                                ...
                                                                {item.ruang_kamar_tiga ? (
                                                                    <img src={item.ruang_kamar_tiga} alt={item.ruang_kamar_tiga} />
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className='detail-content-row-wisata'>
                                                                ...
                                                                {item.ruang_kamar_empat ? (
                                                                    <img src={item.ruang_kamar_empat} alt={item.ruang_kamar_empat} />
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className='detail-content-row-wisata'>
                                                                ...
                                                                {item.ruang_kamar_lima ? (
                                                                    <img src={item.ruang_kamar_lima} alt={item.ruang_kamar_lima} />
                                                                ) : (
                                                                    <span className='subtitle-name text-danger'>Undifined</span>
                                                                )}
                                                            </div>
